                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="p-5">
                                       ...
                                       <form action="<?= base_url('auth/add_user') ?>" method="POST" enctype="multipart/form-data">
                                          <div class="form-group">
                                             <label class="text-dark" for="">Nama</label>
                                             <input type="text" class="form-control form-control-user" name="nama" id="nama" aria-describedby="emailHelp" placeholder="Nama">
                                             <?= form_error('nama','<div class"text-small text_danger">','</div>') ?>
                                          </div>
                                          <div class="form-group">
                                             <label class="text-dark" for="">Nomor Induk Siswa</label>
                                             <input type="text" class="form-control form-control-user" name="nis" id="nis" placeholder="Nomor Induk Siswa">
                                          ...
                                          <div class="form-group">
                                             <label class="text-dark" for="">Password Default</label>
                                          ...
                                          <div class="form-check">
                                             <input class="form-check-input" type="radio" name="jns_kelamin" value="Laki-Laki" id="jns_kelamin" >
                                                Laki_Laki                            
                                             &nbsp &nbsp &nbsp &nbsp
                                             <input class="form-check-input" type="radio" name="jns_kelamin" value="Perempuan" id="jns_kelamin" >
                                                Perempuan
                                             </div>
                                             <?= form_error('jns_kelamin','<div class"text-small text_danger">','</div>') ?>
                                          </div>
                                          <div class="form-group">
                                             ...
                                             <?= form_error('alamat','<div class"text-small text_danger">','</div>') ?>
                                          </div>
                                          <div class="form-group">
                                             <label class="text-dark" for="">Tempat Lahir</label>
                                             <input type="text" class="form-control form-control-user" name="tmpt_lahir" id="tmpt_lahir" placeholder="Tempat Lahir">
                                             <?= form_error('tmpt_lahir','<div class"text-small text_danger">','</div>') ?>
                                          </div>
                                          <div class="form-group">
                                             <label class="text-dark" for="">Tanggal Lahir</label>
                                             <input type="date" class="form-control form-control-user" name="tgl_lahir" id="example2" placeholder="Tanggal Lahir">
                                          </div>
                                          <div class="form-group">
                                          ...
                                          <div class="form-check">
                                             ...
                                             <?= form_error('kelas','<div class"text-small text_danger">','</div>') ?>
                                             </div>
                                          </div>
                                          <div class="form-group">
                                             ...
                                             <?= form_error('no_hp','<div class"text-small text_danger">','</div>') ?>
                                          </div>
                                          <div class="form-group">
                                             <label class="text-dark" for="">Foto</label>
                                             <input type="file" class="form-control form-control-user" name="foto" id="foto" accept="image/jpeg,image/png">
                                             <?= form_error('foto','<div class"text-small text_danger">','</div>') ?>
                                          </div>
                                          <button type="submit" class="btn btn-primary btn-user btn-block">
                                             Upload
                                          </button>
                                          <a href="<?= base_url('admin/siswa') ?>" class="btn btn-warning btn-user btn-block">
                                             Cancel
                                          </a>
                                       </form>
                                       <hr>
